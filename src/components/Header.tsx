    ...
    <header className="flex flex-row items-center w-full">
      <div className="flex flex-auto items-center justify-between py-4 pl-10 border-b-2 border-black border-solid bg-[#ADD8E6] shadow-lg">
        ...
        <div className="flex flex-1 pr-2">
          ...
          />
          <button className="h-10 w-16 border-2 border-black rounded-r-md ml-[-2px] transition duration-300 ease-in-out hover:bg-black hover:text-white">
            Search
          </button>
        </div>
        <div className="flex flex-row flex-1 justify-evenly gap-x-2">
          <div className="content-center w-20 h-10 text-center transition duration-300 ease-in-out border-2 border-black rounded-lg hover:bg-black hover:text-white">
